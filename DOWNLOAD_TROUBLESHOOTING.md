...
- كشف HTML وعرض تحذيرات

### 2. صفحة التحقق من صحة الروابط
الوصول إلى: `/admin/link-validator`

**الميزات:**
- التحقق من صحة الروابط قبل إضافتها
- تحديد أنواع الملفات المدعومة
- تحليل المشاكل والتوصيات
- فحص حجم الملف ونوع المحتوى

### 3. صفحة التشخيص المتقدم
الوصول إلى: `/admin/link-diagnostics`

**الميزات:**
- فحص مجموعة روابط دفعة واحدة
- تحليل شامل للمشاكل
- تصدير النتائج كملف JSON
- توصيات مفصلة لكل رابط
...
- الملفات التي تتطلب مصادقة خاصة
- الملفات المحمية بحقوق النشر
- الملفات التي تحتاج إلى برامج خاصة للفتح
- الملفات التي تتجاوز 100 MB
